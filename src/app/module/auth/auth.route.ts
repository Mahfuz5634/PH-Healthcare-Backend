...
router.post(
	"/verify-email",
	validateRequest(patientValidation.VerifyEmailZodSchema),
...
router.post(
	"/forgot-password",
	validateRequest(authValidation.IForgotPasswordZodSchema),
	AuthController.forgotPassword,
);
router.post(
	"/reset-password",
	validateRequest(authValidation.IResetPasswordZodSchema),
